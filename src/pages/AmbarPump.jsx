...
export default function App() {
    ...
    const getData = () => {
        ...
        let datasets3 = [];
        axios
            .post("http://10.35.13.108:8001/api/getambardatafromdate", {
    ...
    return (
        <div>
            <div className=" mx-auto bg-gray-800 rounded text-white w-1/3  text-center grid grid-cols-3">
                <p>
                    Durum:{" "}
                    {statu === 1
                        ? "Çalışıyor"
            ...
            <div className=" h-auto w-full overflow-hidden p-4">
                <Line
