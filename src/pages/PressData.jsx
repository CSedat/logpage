    ...
    return (
        <div>
            <div className="grid grid-cols-10 text-center items text-[0.65rem] bg-gray-800 rounded p-1 ">
                ...
                <div className=" border border-1 p-1 rounded w-full ">
                    <p className="bg-gray-500 rounded">50</p> Ana Piston
                    Basılıyor 2
                </div>
                <div className=" border border-1 p-1 rounded w-full ">
                    <p className="bg-gray-500 rounded">60</p> Press Besleniyor
                    Rampa 1
                </div>
                <div className=" border border-1 p-1 rounded w-full ">
                    <p className="bg-gray-500 rounded">70</p> Press Besleniyor
                    Rampa 2
                </div>
                <div className=" border border-1 p-1 rounded w-full ">
                ...
                <div className=" border border-1 p-1 rounded w-full ">
                    <p className="bg-gray-500 rounded">(90-100-110)</p>{" "}
                    Sıkılıyor
                </div>
                <div className=" border border-1 p-1 rounded w-full ">
                    <p className="bg-gray-500 rounded">(120-130-140)</p>{" "}
                    Boşaltılıyor
                </div>
                <div className=" border border-1 p-1 rounded w-full ">
            ...
            <div className="mx-auto text-right w-[23rem] grid grid-cols-6 gap-1 bg-gray-800 rounded">
                ...
                >
                    {datedays.map((r) => (
                        <option
                            selected={Number(r.value) === Number(selectedday)}
                            value={r.value}
                        >
                            {r.label}
                        </option>
                ...
                >
                    {datemons.map((r) => (
                        <option
                            selected={Number(r.value) === Number(selectedmon)}
                            value={r.value}
                        >
                            {r.label}
                        </option>
